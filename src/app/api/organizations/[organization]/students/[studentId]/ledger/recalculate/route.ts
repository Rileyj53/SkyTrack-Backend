...
// POST /api/organizations/[organizationId]/students/[studentId]/ledger/recalculate - Recalculate student ledger balance
export const POST = secureApiRoute(async (
  ...
  // Find the student's ledger (still using organization_id in database for now)
  ...
  // Get all approved flight invoices for this student (still using organization_id in database for now)
