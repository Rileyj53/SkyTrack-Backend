...
// GET /api/organizations/[organizationId]/students/[studentId]/flight-invoices - List flight invoices for a student
...
export const POST = secureApiRoute(async (
  ...
  // Validate flight schedule exists and belongs to student (still using organization_id in database for now)
  ...
  // Create flight invoice (still using organization_id in database for now)
