...
// GET /api/organizations/[organizationId]/planes/[planeId]/records - List all records for a plane
export const GET = secureApiRoute(async (
  ...
  // Validate organization ID and plane ID
...
// POST /api/organizations/[organizationId]/planes/[planeId]/records - Create a new record for a plane
export const POST = secureApiRoute(async (
  ...
  if (!mongoose.Types.ObjectId.isValid(params.organization)) {
    console.warn(JSON.stringify({
      level: 'WARN',
      message: 'Invalid organization ID format provided for record creation',
      auditId: securityContext.auditId,
      organizationId: params.organization,
      timestamp: new Date().toISOString()
    }));
  ...
  if (!plane) {
    console.warn(JSON.stringify({
      level: 'WARN',
      message: 'Plane not found or does not belong to organization for record creation',
      auditId: securityContext.auditId,
      planeId: params.planeId,
      organizationId: params.organization,
      timestamp: new Date().toISOString()
...
// PUT /api/organizations/[organizationId]/planes/[planeId]/records - Update multiple records (bulk update)
export const PUT = secureApiRoute(async (
  ...
  if (!mongoose.Types.ObjectId.isValid(params.organization)) {
    console.warn(JSON.stringify({
      level: 'WARN',
      message: 'Invalid organization ID format provided for bulk update',
      auditId: securityContext.auditId,
      organizationId: params.organization,
      timestamp: new Date().toISOString()
    }));
  ...
  if (!plane) {
    console.warn(JSON.stringify({
      level: 'WARN',
      message: 'Plane not found or does not belong to organization for bulk update',
      auditId: securityContext.auditId,
      planeId: params.planeId,
      organizationId: params.organization,
      timestamp: new Date().toISOString()
...
// DELETE /api/organizations/[organizationId]/planes/[planeId]/records - Delete multiple records (bulk delete)
export const DELETE = secureApiRoute(async (
  ...
  if (!mongoose.Types.ObjectId.isValid(params.organization)) {
    console.warn(JSON.stringify({
      level: 'WARN',
      message: 'Invalid organization ID format provided for bulk deletion',
      auditId: securityContext.auditId,
      organizationId: params.organization,
      timestamp: new Date().toISOString()
    }));
  ...
  if (!plane) {
    console.warn(JSON.stringify({
      level: 'WARN',
      message: 'Plane not found or does not belong to organization for bulk deletion',
      auditId: securityContext.auditId,
      planeId: params.planeId,
      organizationId: params.organization,
      timestamp: new Date().toISOString()
